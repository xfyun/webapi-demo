...
//测试唤醒词引擎
func ocrClient(serverUrl string, reqData []byte, client *fasthttp.Client) {
...
func main() {
	//定义命令行参数
	flag.Usage = Usage
	url := flag.String("url", "https://tyocr.xfyun.cn/v2/ocr", "connect server url")
	res := flag.String("res", "ocr.jpg", "res path")
	flag.Parse()
	audioFile1 := *res
