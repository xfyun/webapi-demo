...
//测试唤醒词引擎
func ivwClient(serverUrl string, reqData []byte, client *fasthttp.Client) {
...
func main() {
	//定义命令行参数
	flag.Usage = Usage
	url := flag.String("url", "https://rest-api.xfyun.cn/v2/ivw", "connect server url")
