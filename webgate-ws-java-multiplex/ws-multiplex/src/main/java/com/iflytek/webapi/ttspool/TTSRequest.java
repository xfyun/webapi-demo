...
public class TTSRequest {
    ...
    public TTSRequest setCommon(Common common) {
        this.common = common;
        return this;
    }
    ...
    public TTSRequest setBusiness(Map<String, Object> business) {
    ...
    public TTSRequest setData(Data data) {
        this.data = data;
        return this;
    }
}
