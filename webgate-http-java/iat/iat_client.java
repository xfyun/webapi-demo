...
public class iat_client {
    private static final String HOST_URL = "https://rest-api-gz.xfyun.cn/v2/iat";
    private static final String API_KEY = "48xxxxxxxxxxxxxxx";
    private static final String API_SECRET = "Tx74pxxxxxxxxxxxx";

    private static final String body =
            "{\"business\": {\"language\": \"zh_cn\",\"domain\":   \"xxx\",\"accent\":   \"mandarin\"}," +
                    " \"common\": {\"app_id\": \"5xxxxxxx\"}," +
                    "\"data\": {\"format\": \"audio/L16;rate=16000\",\"encoding\":\"raw\",\"audio\": \"";


    public static final MediaType JSON = MediaType.parse("application/json;charset=utf-8");
    private static final String path = "./webgate-http-java/com/authentic/http/iat/iattest.pcm";
