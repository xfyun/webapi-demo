...
public class ivw_client {
    private static final String HOST_URL = "https://rest-api.xfyun.cn/v2/ivw";
    private static final String API_KEY = "48xxxxxxxxxxxxxxx";
    private static final String API_SECRET = "Tx74pxxxxxxxxxxxx";


    private static final String body =
            "{\"business\": {\"ent\": \"ivw\",\"keyword\": \"叮咚叮咚\",\"threshold\":\"1314\"}," +
                    " \"common\": {\"app_id\": \"5xxxxxxx\"}," +
                    "\"data\": {\"format\":\"16000\",\"encoding\":\"raw\",\"audio\": \"";


    //        public static final MediaType JSON = MediaType.parse("application/json,version=1.0");
    public static final MediaType JSON = MediaType.parse("application/json;charset=utf-8");
    private static final String path = "./webgate-http-java/com/authentic/http/ivw/ivwtest.pcm";
