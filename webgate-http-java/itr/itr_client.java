...
public class itr_client {
    ...
    private static final String body = "{\"business\": {\"ent\": \"phfw-chapter\", \"aue\": \"raw\"}, \"common\": {\"app_id\": \"5xxxxxxx\"},\"data\": {\"image\": \"";
    public static final MediaType JSON = MediaType.parse("application/json;charset=utf-8");
    private static final String path = "./webgate-http-java/com/authentic/http/itr/itrtest.jpg";
